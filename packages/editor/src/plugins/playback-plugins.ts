...
// Continuation tooltip plugin — shows a "continuation" tooltip when hovering the ⤤ mark.
// (This used to also highlight every block in the chain by toggling a class directly on
// the nodeview wrappers — a ProseMirror anti-pattern that broke clicking into those blocks
// in Electron. That chain-highlight was removed; timeline-driven highlights use proper
// Decorations instead: is-playing / is-looping, and BlockHighlightOverlay.)
